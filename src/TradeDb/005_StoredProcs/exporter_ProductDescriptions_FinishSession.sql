/* =============================================
 ...
 ============================================= */
CREATE PROCEDURE [dbo].[exporter_ProductDescriptions_FinishSession]
...
BEGIN
	...
	BEGIN TRY
		...
		IF (@ExportStatusId = 2)
		BEGIN
			DELETE FROM FeedExportProductDescriptions 
		...
		BEGIN
			...
			(SELECT ISBN13 FROM FeedExportProductDescriptionsInvalid WITH (NOLOCK)
			 WHERE SessionId = @SessionId
			 GROUP BY ISBN13, EBookID) AS Invalid;
		END
...
GRANT EXECUTE ON [dbo].[exporter_ProductDescriptions_FinishSession] TO [FeedsExporter]; 
GO